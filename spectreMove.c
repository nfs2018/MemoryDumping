...
void * movement()
{
    ...
    int i, a=0;
    char random[] = "gggggggggggggggggggggggggggggggggggggggg";
    for(i=0;i<11;i++){
        r[i] = malloc(41);
        strkopi(r[i],random,random);
    }
    i=0;
    int j=0;
    char timpa[]= "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb";
    gkey=secret;
...
int main(int argc,
  ...
  uint8_t value[2];
  int i;
  char * cmd;//= "The Magic Words are Squeamish Ossifrage.";  
  //secret=keys;
